...
public class Grid : MonoBehaviour {
    ...
    //private void OnValidate() { // This can be used to ensure that when you modify data in an editor that the data stays within a certain range.
    //    Generate();
    // }
